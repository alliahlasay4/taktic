      ...
      <div>
        <div className="flex items-start justify-between gap-2 mb-2">
          ...
          {isPodActive ? (
            ...
            <span className="inline-flex items-center gap-1.5 rounded-full bg-[var(--card-hover)] border border-[var(--border-subtle)] px-2.5 py-0.5 text-[10px] font-medium text-[var(--text-muted)]">
      ...
      <div className="mt-4 pt-3 border-t border-[var(--border-subtle)] space-y-3">
        <div className="flex items-center justify-between text-[10px] text-[var(--text-muted)]">
          <span className="flex items-center gap-1">
            <Calendar className="h-3 w-3 text-[var(--accent-warm-ochre)]" />
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="text-[10px] font-bold text-[var(--accent-terracotta)] hover:underline"
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="flex-1 flex items-center justify-center gap-1.5 rounded-xl bg-[var(--accent-terracotta)] hover:brightness-110 text-white px-3 py-2 text-xs font-bold shadow-xs transition active:scale-95 min-h-[38px]"
          >
          ...
          <button
            ...
            className="flex items-center gap-1 rounded-xl border border-[var(--border-subtle)] bg-[var(--card-hover)] px-2.5 py-2 text-xs font-semibold text-[var(--text-secondary)] hover:border-[var(--accent-terracotta)]/40 hover:text-[var(--text-primary)] transition min-h-[38px]"
